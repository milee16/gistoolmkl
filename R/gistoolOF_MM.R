#' Gradient analysis of Odense Fjord
#'
#' Uses Model data with four gradient polygons and tree different scenarios
#' @param WBData Tables of gradient polygons
#' @return Vertical profiles and Monod growth kinetics in various plots
#' @export
gistoolOF_MM <- function() {
  ...
  WB_B_lo_b_AG <<- c((sum(WB_B_G1_no_Aspec$lo_b))/WB_sumarea_G1,(sum(WB_B_G2_no_Aspec$lo_b))/WB_sumarea_G2,(sum(WB_B_G3_no_Aspec$lo_b))/WB_sumarea_G3,(sum(WB_B_G4_no_Aspec$lo_b))/WB_sumarea_G4)
  ...
  WB_S1_lo_b_AG <<- c((sum(WB_S1_G1_no_Aspec$lo_b))/WB_sumarea_G1,(sum(WB_S1_G2_no_Aspec$lo_b))/WB_sumarea_G2,(sum(WB_S1_G3_no_Aspec$lo_b))/WB_sumarea_G3,(sum(WB_S1_G4_no_Aspec$lo_b))/WB_sumarea_G4)
  ...
  WB_S2_lo_b_AG <<- c((sum(WB_S2_G1_no_Aspec$lo_b))/WB_sumarea_G1,(sum(WB_S2_G2_no_Aspec$lo_b))/WB_sumarea_G2,(sum(WB_S2_G3_no_Aspec$lo_b))/WB_sumarea_G3,(sum(WB_S2_G4_no_Aspec$lo_b))/WB_sumarea_G4)
  ...
  WB_B_PREC_vs_lower <<- ggplot(WB_B_AG, aes(x = PREC, y = lower, group = WB_gradient_no)) +
    ...
    scale_y_continuous(limits = c(-4,0), breaks = seq(-4,0, by = 1), labels = scales::number_format(accuracy = 1))
  ...
  WB_B_PRBC1_vs_lower <<- ggplot(WB_B_AG, aes(x = PRBC1, y = lower, group = WB_gradient_no)) +
    ...
    scale_x_continuous(limits = c(0,100), breaks = seq(0,100, by = 20), labels = scales::number_format(accuracy = 1), position = 'top') +
    scale_y_continuous(limits = c(-4,0), breaks = seq(-4,0, by = 1), labels = scales::number_format(accuracy = 1))
  ...
  WB_B_PRBC2_vs_lower <<- ggplot(WB_B_AG, aes(x = PRBC2, y = lower, group = WB_gradient_no)) +
    ...
    scale_x_continuous(limits = c(0,12), breaks = seq(0,12, by = 2), labels = scales::number_format(accuracy = 1), position = 'top') +
    scale_y_continuous(limits = c(-4,0), breaks = seq(-4,0, by = 1), labels = scales::number_format(accuracy = 1))
  ...
  WB_B_PC_vs_lower <<- ggplot(WB_B_AG, aes(x = PC, y = lower, group = WB_gradient_no)) +
    ...
    scale_x_continuous(limits = c(0,6), breaks = seq(0,6, by = 1), labels = scales::number_format(accuracy = 1), position = 'top') +
    scale_y_continuous(limits = c(-4,0), breaks = seq(-4,0, by = 1), labels = scales::number_format(accuracy = 1))
  ...
  WB_AS_G1_PC <<- ggplot(WB_G1_AS, aes(x = PC, y = lower, group = scenario)) +
    ...
    scale_x_continuous(limits = c(0,3), breaks = seq(0,3, by = 0.5), labels = scales::number_format(accuracy = 0.1), position = 'top') +
    scale_y_continuous(limits = c(-4,0), breaks = seq(-4,0, by = 1), labels = scales::number_format(accuracy = 1))
  ...
  WB_monod_BC1_DIP <<- ggplot(subset(WB_monod_table, scenario %in% c('Baseline', 'N-30%')), aes(x = BC1_kmDIP, y = lower, group = interaction(scenario, WB_gradient_no))) +
    ...
    scale_color_manual(values = c('black', 'orange', 'black')) +
    scale_fill_manual(values = c('black', 'black', 'black', 'white', 'white')) +
    scale_x_continuous(limits = c(0,1.09), breaks = seq(0,1.09, by = 0.1), labels = scales::number_format(accuracy = 0.1), position = 'top') +
    scale_y_continuous(limits = c(-4,0), breaks = seq(-4,0, by = 1), labels = scales::number_format(accuracy = 1)) +
  ...
  WB_monod_PC_DIN <<- ggplot(subset(WB_monod_table, scenario %in% c('Baseline', 'N-30%')), aes(x = PC_kmDIN, y = lower, group = interaction(scenario, WB_gradient_no))) +
    ...
    scale_color_manual(values = c('black', 'orange', 'black')) +
    scale_fill_manual(values = c('black', 'black', 'black', 'white', 'white')) +
    scale_x_continuous(limits = c(0.2,1.1), breaks = seq(0.2,1.1, by = 0.2), labels = scales::number_format(accuracy = 0.1), position = 'top') +
    scale_y_continuous(limits = c(-4,0), breaks = seq(-4,0, by = 1), labels = scales::number_format(accuracy = 1)) +
  ...
  WB_monod_PC_DIP <<- ggplot(subset(WB_monod_table, scenario %in% c('Baseline', 'N-30%')), aes(x = PC_kmDIP, y = lower, group = interaction(scenario, WB_gradient_no))) +
    ...
    scale_color_manual(values = c('black', 'orange', 'black')) +
    scale_fill_manual(values = c('black', 'black', 'black', 'white', 'white')) +
    scale_x_continuous(limits = c(0.4,1.1), breaks = seq(0.4,1.1, by = 0.2), labels = scales::number_format(accuracy = 0.1), position = 'top') +
    scale_y_continuous(limits = c(-4,0), breaks = seq(-4,0, by = 1), labels = scales::number_format(accuracy = 1)) +
  ...
  WB_monod_PC_light <<- ggplot(subset(WB_monod_table, scenario %in% c('Baseline', 'N-30%')), aes(x = PC_kmlight, y = lower, group = interaction(scenario, WB_gradient_no))) +
    ...
    scale_color_manual(values = c('black', 'orange', 'black')) +
    scale_fill_manual(values = c('black', 'black', 'black', 'white', 'white')) +
    scale_x_continuous(limits = c(0.3,1), breaks = seq(0.3,1, by = 0.1), labels = scales::number_format(accuracy = 0.1), position = 'top') +
    scale_y_continuous(limits = c(-4,0), breaks = seq(-4,0, by = 1), labels = scales::number_format(accuracy = 1)) +
  ...
  WB_monod_PC_DIN + theme_pub() + theme(plot.margin = unit(c(15,1,1,1), "pt"), axis.title = element_text(size = 18), legend.justification = c(1,1.75),
                                        legend.direction = 'vertical',
                                        legend.box = 'vertical') +
    WB_monod_PC_DIP + theme_pub() + theme(plot.margin = unit(c(15,1,1,1), "pt"), axis.title = element_text(size = 18), legend.justification = c(1.1,1.75),
                                          legend.direction = 'vertical',
                                          legend.box = 'vertical') +
  ...
  WB_monod_BC2_DIN <<- ggplot(subset(WB_monod_table, scenario %in% c('Baseline', 'N-30%')), aes(x = BC2_kmDIN, y = lower, group = interaction(scenario, WB_gradient_no))) +
    ...
    scale_color_manual(values = c('black', 'orange', 'black')) +
    scale_fill_manual(values = c('black', 'black', 'black', 'white', 'white')) +
    scale_x_continuous(limits = c(0.3,1.1), breaks = seq(0.3,1.09, by = 0.1), labels = scales::number_format(accuracy = 0.1), position = 'top') +
    scale_y_continuous(limits = c(-4,0), breaks = seq(-4,0, by = 1), labels = scales::number_format(accuracy = 1)) +
  ...
  WB_monod_BC2_light <<- ggplot(subset(WB_monod_table, scenario %in% c('Baseline', 'N-30%')), aes(x = BC2_kmlight, y = lower, group = interaction(scenario, WB_gradient_no))) +
    ...
    scale_color_manual(values = c('black', 'orange', 'black')) +
    scale_fill_manual(values = c('black', 'black', 'black', 'white', 'white')) +
    scale_x_continuous(limits = c(0.2,0.8), breaks = seq(0.2,0.8, by = 0.1), labels = scales::number_format(accuracy = 0.1), position = 'top') +
    scale_y_continuous(limits = c(-4,0), breaks = seq(-4,0, by = 1), labels = scales::number_format(accuracy = 1)) +
  ...
  WB_monod_BC2_DIN + theme_pub() + theme(plot.margin = unit(c(15,1,1,1), "pt"), axis.title = element_text(size = 18), legend.justification = c(1.1,1.75),
                                         legend.direction = 'vertical',
                                         legend.box = 'vertical') +
    WB_monod_BC2_DIP + theme_pub() + theme(plot.margin = unit(c(15,1,1,1), "pt"), axis.title = element_text(size = 18), legend.justification = c(1.1,1.75),
                                           legend.direction = 'vertical',
                                           legend.box = 'vertical') +
