...
gistoolOF <- function() {
  ...
  WB_PREC_vs_AvgDIN <<- ggplot(WB_AS_AG_FINAL, aes(x = AvgDIN, y = PREC, group = scenario)) +
    ...
    scale_x_continuous(limits = c(0,0.50), breaks = seq(0,0.50, by = 0.1), labels = scales::number_format(accuracy = 0.05)) +
  ...
  WB_PRBC1_vs_AvgDIN <<- ggplot(WB_AS_AG_FINAL, aes(x = AvgDIN, y = PRBC1, group = scenario)) +
    ...
    scale_x_continuous(limits = c(0,0.50), breaks = seq(0,0.50, by = 0.1), labels = scales::number_format(accuracy = 0.05)) +
    scale_y_continuous(limits = c(0,60), breaks = seq(0,60, by = 10), labels = scales::number_format(accuracy = 1))
  ...
  WB_PRPC_vs_AvgDIN <<- ggplot(WB_AS_AG_FINAL, aes(x = AvgDIN, y = PRPC, group = scenario)) +
    ...
    scale_x_continuous(limits = c(0,0.50), breaks = seq(0,0.50, by = 0.1), labels = scales::number_format(accuracy = 0.05)) +
    scale_y_continuous(limits = c(0,150), breaks = seq(0,150, by = 20), labels = scales::number_format(accuracy = 1))
  ...
  WB_monod_EC_light <<- ggplot(subset(WB_monod_table, scenario %in% c('Baseline', 'N-30%')), aes(x = EC_kmlight, y = lower, group = interaction(scenario, WB_gradient_no))) +
    ...
    scale_y_continuous(limits = c(-12,0), breaks = seq(-12,0, by = 2), labels = scales::number_format(accuracy = 1)) +
